...
PLATFORMIO_HOME=".platformio-ide"
...
DEPENDENCIES = {
    ...
    "platformio-ide": { "autocomplete-clang", "build", "busy-signal", "file-icons", "intentions",
                        "language-ini", "linter", "linter-gcc", "linter-ui-default",
                        "platformio-ide-debugger", "platformio-ide-terminal", "tool-bar", }
}
...
def read_pkgs_file():
    ...
    if platform.system() == "Windows":
        fname = "pio-windows-packages.txt"
...
def main():
    ...
    if args.list_keys:
        ...
        os.environ["ATOM_HOME"] = os.path.join(os.environ["HOME"], PLATFORMIO_HOME)
